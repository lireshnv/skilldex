...
/** The interactive Skill Graph visualization — bubble nodes, hover-illuminate,
 * zoom/pan, click-to-inspect. Extracted from the old standalone page so it can
 * be embedded as a tab (Skills > Graph) as well as linked to directly. */
