...
export default function RecruiterNotificationsPage() {
  const list = notificationsFor("recruiter");
  ...
  return (
    <PortalShell
      ...
      userColor="#0b1e3f"
      userRole="Senior Talent Acquisition"
      breadcrumbs={[{ label: "Recruiter", href: "/industry/recruiter" }, { label: "Notifications" }]}
    >
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Notifications</h1>
          <p className="text-sm text-muted-foreground">Candidate matches, pipeline moves and interview reminders.</p>
        </div>
