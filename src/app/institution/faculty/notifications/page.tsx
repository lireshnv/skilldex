...
import { notificationsFor, currentFaculty } from "@/lib/data";
...
export default function FacultyNotificationsPage() {
  const list = notificationsFor("faculty");
  ...
  return (
    <PortalShell
      ...
      breadcrumbs={[{ label: "Faculty", href: "/institution/faculty" }, { label: "Notifications" }]}
    >
